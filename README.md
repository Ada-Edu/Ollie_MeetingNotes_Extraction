...
|---|---|---|--:|--:|--:|--:|
| `helm` | ❌ `failed` [↗](https://github.com/Ada-Edu/Ollie_MeetingNotes_Extraction/actions/runs/29718446048) | — | — | — | 0 | 2 |
| `seed` | ❌ `failed` [↗](https://github.com/Ada-Edu/Ollie_MeetingNotes_Extraction/actions/runs/29718446048) | — | — | — | 0 | 2 |
