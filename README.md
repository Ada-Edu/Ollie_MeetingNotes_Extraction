...
|---|---|---|--:|--:|--:|--:|
| `helm` | ❌ `failed` [↗](https://github.com/Ada-Edu/Ollie_MeetingNotes_Extraction/actions/runs/28873172658) | — | — | — | 0 | 1 |
| `seed` | ❌ `failed` [↗](https://github.com/Ada-Edu/Ollie_MeetingNotes_Extraction/actions/runs/28873172658) | — | — | — | 0 | 1 |
